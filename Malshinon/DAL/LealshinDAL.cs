...
namespace Malshinon.DAL
{
    internal class LealshinDAL
    {
        ...
        public void addToLealshin(Lealshin lealshin)
        {
            ...
            string query = "INSERT INTO malshinim(malshin_first_name,malshin_last_name,malshin_secret_code,malshin_status,malshin_about,malshin_content_halshana)" +
                "VALUES (@malshin_first_name,@malshin_last_name,@malshin_secret_code,@malshin_status,@malshin_about,@malshin_content_halshana)";
            ...
            using(MySqlConnection conn = new MySqlConnection(connStr)){
                ...
                cmd.Parameters.AddWithValue(@"malshin_content_halshana",lealshin.malshin_content_halshana);
